<form action="<?php echo base_url().'admin/setting/custom_field' ?>" method="post" id="customField_form" >
	...
	<div class="form-group form-float">
		<div class="form-line">
			<input type="text" name="field_name" class="form-control" value="<?= isset($data->name)?$data->name:''; ?>">
	...
	<div class="form-group">
		<?php if(isset($data->custom_fields_id)) { ?>
			<input type="hidden" name="id" value="<?php echo $data->custom_fields_id; ?>">
