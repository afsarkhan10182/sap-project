...
<html>
	...
	<body class="hold-transition login-page">
		<div class="login-box">
	        ...
	        <div class="card">
	            <div class="body">
	                <form action="<?php echo base_url().'admin/user/auth_user'; ?>" method="post" id="login-form">
	                    ...
	                    <div class="row m-t-15 m-b--20">
	                    	<?php if(setting_all('register_allowed')==1){ ?>
		                        <div class="col-xs-6">
		                            <a href="<?php echo base_url().'admin/user/registration'; ?>"><?php echo lang('register_now') ?>!</a>
		                        </div>
	                        <?php } ?>
	                        <div class="col-xs-6 align-right">
	                            <a href="<?php echo base_url().'admin/user/forgetpassword' ?>"><?php echo lang('forgot_password') ?>?</a>
	                        </div>
	                    </div>
	                </form>
	            </div>
