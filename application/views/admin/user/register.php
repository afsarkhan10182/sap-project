    ...
    <div class="signup-box">
      ...
      <div class="card">
        <div class="body">
          ...
          <form action="<?php echo base_url().'admin/user/registration'; ?>" method="post" id="register-form">
          ...
          <br>
          <a href="<?php echo base_url('admin/user/login');?>" class="text-center"><?php echo lang('i_already_have_a_membership'); ?></a>
        </div>
      </div>
      <!-- /.form-box -->
    </div>
...
$(document).ready(function(){
  <?php if($this->input->get('invited') && $this->input->get('invited') != ''){ ?>
    ...
    $.ajax({
      url: $burl+'admin/user/chekInvitation',
      method:'post',
      data:{
      ...
      if(data.result == 'success') {
        ...
        $('form').attr('action', $burl + 'admin/user/register_invited/' + data.users_id);
      } else{
        window.location.href= $burl + 'admin/user/login';
      }
    });
  <?php } ?>
