    ...
    if($email=='allredyUsed'){ ?>
      <div class="container text-center">
        <h2><?php echo lang('you_have_already_reset_your_password'); ?>..</h2>
         <p><?php echo lang('please_login'); ?> <a href="<?php echo base_url().'admin/user/login'; ?>"><?php echo lang('here'); ?></a> </p>
      </div>
    <?php } else{  ?>
    <div class="fp-box">
      ...
      <div class="card">
        <div class="body">
          <div class="inner_container loginpage login-box login-box-body">
            <section>
              <form class="createaccount" action="<?php echo base_url().'admin/user/reset_password'?>" method="post">
