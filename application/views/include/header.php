    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url('admin/user/profile');?>"><i class="material-icons">person</i><?php echo lang("Profile");?></a></li>
                            <li role="seperator" class="divider"></li>
                            <li><a href="<?php echo base_url('admin/user/logout');?>"><i class="material-icons">input</i><?php echo lang("Signout");?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<li class="<?=($this->router->method==="dashboard")?"active":"not-active"?>">
				<a href="<?php echo base_url('admin/user/dashboard');?>"> <i class="material-icons">dashboard</i> <span><?php echo lang("dashboard");?></span></a>
			</li>
                    ...
                    <li class="<?=($this->router->method==="userTable")?"active":"not-active"?>">
                        <a href="<?php echo base_url();?>admin/user/userTable" class="EditCrud" data-crud_id="124">
                    ...
                    <li class="<?=($this->router->class==="setting")?"active":"not-active"?>">
                        <a href="<?php echo base_url("admin/setting"); ?>"><i class="material-icons">settings_applications</i> <span><?php echo lang('settings'); ?></span></a>
                    </li>


                  <?php } ?>

                  <li class="treeview <?=($this->router->class==="invoice")?"active":"not-active"?>">
                    <a href="javascript:void(0);" class="menu-toggle">
                        <i class="material-icons">swap_calls</i>
                        <span><?php echo lang('invoice') ?></span>
                    </a>
                    <ul class="ml-menu">
                      <li class="<?=($this->router->method==="view")?"active":"not-active"?>">
                        <a href="<?php echo base_url("admin/invoice/view"); ?>"><span><?php echo lang('invoice_list') ?></span></a>
                      </li>
                      <li class="<?=($this->router->method==="setting")?"active":"not-active"?>">
                        <a href="<?php echo base_url("admin/invoice/setting"); ?>"><span><?php echo lang('invoice_settings') ?></span></a>
                      </li>
                    </ul>
                  </li>
