  ...
  /**
	 ...
	 function edit_setting() {
		...
		if($this->input->post('mail_setting')){
			redirect( base_url().'admin/setting#emailSetting', 'refresh');
		} else {
	...
	public function permission() {
		...
		$art_msg['type'] = 'success';
		$this->session->set_userdata('alert_msg', $art_msg);
		redirect( base_url().'admin/setting#permissionSetting', 'refresh');
	}
	...
	public function custom_field() {
		...
		redirect(base_url().'/admin/setting#custom-fields-div');
	...
	public function get_modal() {
		...
		if($this->input->post('id')){
			$data['data']= $this->Setting_model->Get_data_id($this->input->post('id'));
      		echo $this->load->view('admin/setting/add_update', $data, true);
	    } else {
	      	echo $this->load->view('admin/setting/add_update', $data, true);
	    }
	    exit;
